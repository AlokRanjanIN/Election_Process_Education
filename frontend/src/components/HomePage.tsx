    ...
    <div className="animate-fade-in">
      ...
      <section className="bg-gradient-to-br from-primary-800 via-primary-900 to-indigo-950 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl sm:text-2xl text-primary-200 mb-2">
            {t('app.subtitle')}
          </p>
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            ...
            >
              <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform duration-200`}>
                {feature.icon}
              </div>
